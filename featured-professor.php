...
/*
  Plugin Name: Featured Professor Gutenberg Block 
  Description: Adds a Featured Professor block type to the Gutenberg menu options
  Version: 1.1
  Author: David Heckel
  Author URI: https://davidheckel.dev
